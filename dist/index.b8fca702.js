...
;
/* 購物車增加按鈕 */ for(let i = 0; i < cardbody.length; i++)cardbody[i].addEventListener("click", (e)=>{
    const catItem = `<tr class="item">
                <td>${cat[i]}</td>
...
/* 購物車刪除按鈕 */ tbody.addEventListener("click", (e)=>{
    if (e.target.nodeName === "BUTTON") e.target.parentElement.parentElement.remove();
    if (e.target.nodeName === "I") e.target.parentElement.parentElement.parentElement.remove();
});
/* 清空購物車按鈕 */ cleancartbtn.addEventListener("click", (e)=>{
    tbody.textContent = "";
...
/* 修改input數量，小計金額變動 */ function updatePrice() {
...
},{"bootstrap/dist/css/bootstrap.css":"jJvnD","@fortawesome/fontawesome-free/css/all.css":"8OILE"}],"jJvnD":[function() {},{}],"8OILE":[function() {},{}]},["5anPP","3cYfC"], "3cYfC", "parcelRequirefe43")
